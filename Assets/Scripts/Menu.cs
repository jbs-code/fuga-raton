...
public class Menu : MonoBehaviour {
	...
	void OnGUI(){
        ...
        //    Application.Quit();
        if (GUI.Button (new Rect (Screen.width / 1.43f, Screen.height/1.25f, Screen.width / 5.0f, Screen.width / 12.0f), "Ayuda"))
			 SceneManager.LoadScene("preferencias");
		if (GUI.Button (new Rect (Screen.width / 2.5f, Screen.height/1.25f, Screen.width / 5.0f, Screen.width / 12.0f), "Puntuación"))
